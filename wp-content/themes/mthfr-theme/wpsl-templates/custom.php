...
$output .= "\t\t\t" . '<table><thead><tr><th style="width: 30%;">Practitionar</th><th style="width: 30%;">Address</th><th style="width: 30%;">Contact</th><th style="width: 10%;">Distance</th></tr></thead></table><ul sty></ul>' . "\r\n";
$output .= "\t\t" . '</div>' . "\r\n";
