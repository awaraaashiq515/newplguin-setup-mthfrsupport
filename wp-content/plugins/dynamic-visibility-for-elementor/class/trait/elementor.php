...
trait Elementor {
	...
	public static function is_swiper_latest() {
		if ( version_compare( ELEMENTOR_VERSION, '3.28.0', '>=' ) ) {
			// Since Elementor 3.28.0+ the experiments feature check is no longer needed
			// as Swiper latest is now the default
			return true;
		}
		return \Elementor\Plugin::$instance->experiments->is_feature_active( 'e_swiper_latest' );
	}
	/**
	 * Get Current Post ID
	 *
