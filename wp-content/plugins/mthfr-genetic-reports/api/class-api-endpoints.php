...
if (class_exists('MTHFR_PDF_Generator') && method_exists('MTHFR_PDF_Generator', 'test_generation')) {
    ...
    public function generate_report($request) {
        try {
            ...
            // Check if Async Report Generator class is available
            if (!class_exists('MTHFR_Async_Report_Generator')) {
                throw new Exception('Async Report Generator class not available');
            }
            ...
            $action_id = MTHFR_Async_Report_Generator::schedule_report_generation(
                ...
                array(
                    ...
                    'api_trigger' => true // Mark as API triggered
                )
            );
            ...
            if ($action_id) {
                ...
                $result = array(
                    'success' => false,
                    'error' => 'Failed to queue report generation job',
                    'timestamp' => current_time('c')
                );
            }
